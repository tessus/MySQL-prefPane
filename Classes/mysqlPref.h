...
@class MSPPDaemonController;
@class MSPPMBSliderButton;

@interface mysqlPref : NSPreferencePane {
	MSPPMBSliderButton *__weak theSlider;
	NSTextField *__weak launchPathTextField;
	NSTextField *__weak pidtext;
@private
	MSPPDaemonController *daemonController;
...
@property (nonatomic, weak) IBOutlet MSPPMBSliderButton	*theSlider;
