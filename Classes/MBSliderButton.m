...
@interface MSPPMBKnobAnimation : NSAnimation
{
	int start, range;
	id delegate;
}
@end
@implementation MSPPMBKnobAnimation
...
{
	MSPPMBKnobAnimation* a = [[MSPPMBKnobAnimation alloc] initWithStart:location.x end:x];
	[a setDelegate:self];
